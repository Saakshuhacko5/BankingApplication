...
import com.example.bankingapplication.Adaptors.AccountAdapter;
...
public class AccountOverviewFragment extends Fragment {
    ...
    private View.OnClickListener addAccountClickListener = new View.OnClickListener() {
        ...
        public void onClick(View view) {
            if (view.getId() == btnCancel.getId()) {
                ...
                Toast.makeText(accountDialog.getOwnerActivity(), "Account Creation Cancelled", Toast.LENGTH_SHORT).show();
    ...
    private void setValues() {
        ...
        adapter = new AccountAdapter(this.getActivity(), R.layout.lst_accounts, userProfile.getAccounts());
