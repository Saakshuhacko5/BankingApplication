package com.example.bankingapplication.Model.db;
...
import com.example.bankingapplication.Model.Payee;
...
public class ApplicationDB {
    ...
    private static final String CREATE_PROFILES_TABLE = "CREATE TABLE " + PROFILES_TABLE + " (" + PROFILE_ID + " INTEGER PRIMARY KEY AUTOINCREMENT, " + FIRST_NAME + " TEXT, " + LAST_NAME + " TEXT, " + COUNTRY + " TEXT, " + USERNAME + " TEXT, " + PASSWORD + " TEXT)";

    private static final String CREATE_PAYEES_TABLE = "CREATE TABLE " + PAYEES_TABLE + " (" + PROFILE_ID + " INTEGER NOT NULL, " + PAYEE_ID + " TEXT NOT NULL, " + PAYEE_NAME + " TEXT, " + "PRIMARY KEY(" + PROFILE_ID + "," + PAYEE_ID + "), " + "FOREIGN KEY(" + PROFILE_ID + ") REFERENCES " + PROFILES_TABLE + "(" + PROFILE_ID + "))";

    private static final String CREATE_ACCOUNTS_TABLE = "CREATE TABLE " + ACCOUNTS_TABLE + " (" + PROFILE_ID + " INTEGER NOT NULL, " + ACCOUNT_NO + " TEXT NOT NULL, " + ACCOUNT_NAME + " TEXT, " + ACCOUNT_BALANCE + " REAL, " + "PRIMARY KEY(" + PROFILE_ID + "," + ACCOUNT_NO + "), " + "FOREIGN KEY(" + PROFILE_ID + ") REFERENCES " + PROFILES_TABLE + "(" + PROFILE_ID + "))";

    private static final String CREATE_TRANSACTIONS_TABLE = "CREATE TABLE " + TRANSACTIONS_TABLE + " (" + PROFILE_ID + " INTEGER NOT NULL, " + ACCOUNT_NO + " TEXT NOT NULL, " + TRANSACTION_ID + " TEXT NOT NULL, " + TIMESTAMP + " TEXT, " + SENDING_ACCOUNT + " TEXT, " + DESTINATION_ACCOUNT + " TEXT, " + TRANSACTION_PAYEE + " TEXT, " + TRANSACTION_AMOUNT + " REAL, " + TRANS_TYPE + " TEXT, " + "PRIMARY KEY(" + PROFILE_ID + "," + ACCOUNT_NO + "," + TRANSACTION_ID + "), " + "FOREIGN KEY(" + PROFILE_ID + "," + ACCOUNT_NO + ") REFERENCES " + ACCOUNTS_TABLE + "(" + PROFILE_ID + "," + ACCOUNT_NO + ")," + "FOREIGN KEY(" + PROFILE_ID + ") REFERENCES " + PROFILES_TABLE + "(" + PROFILE_ID + "))";
    ...
    public void overwriteAccount(Profile profile, Account account) {
        ...
        database.update(ACCOUNTS_TABLE, cv, PROFILE_ID + "=? AND " + ACCOUNT_NO + "=?", new String[]{String.valueOf(profile.getDbId()), account.getAccountNo()});
        database.close();
    }
    ...
    public ArrayList<Profile> getAllProfiles() {
        ...
        Cursor cursor = database.query(PROFILES_TABLE, null, null, null, null, null, null);
    ...
    public ArrayList<Payee> getPayeesFromCurrentProfile(long profileID) {
        ...
        Cursor cursor = database.query(PAYEES_TABLE, null, null, null, null, null, null);
    ...
    public ArrayList<Transaction> getTransactionsFromCurrentAccount(long profileID, String accountNo) {
        ...
        Cursor cursor = database.query(TRANSACTIONS_TABLE, null, null, null, null, null, null);
    ...
    public ArrayList<Account> getAccountsFromCurrentProfile(long profileID) {
        ...
        ArrayList<Account> accounts = new ArrayList<>();
        database = openHelper.getReadableDatabase();
        Cursor cursor = database.query(ACCOUNTS_TABLE, null, null, null, null, null, null);
